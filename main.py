...
def main():
    ...
    parser.add_argument('--data_dir', type=str, default='flowers102', help='distance metric')
    ...
    channel, im_size, num_classes, class_names, mean, std, dst_train, dst_test, testloader = get_dataset(args.data_dir)
    
    #print('show_data: ',  dst_train)
    #print('show_data: ',  dst_test)
    #print('show_data: ', testloader)
